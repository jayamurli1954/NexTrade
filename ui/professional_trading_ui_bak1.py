    ...
    try:
        while self.analysis_running:
            try:
                ...
                sample_signals = [
                    {'symbol': 'RELIANCE','action': 'BUY','price': 2456.75,'confidence': 85,'reason': 'Golden ratio support + oversold RSI + high volume'},
                    {'symbol': 'TCS','action': 'SELL','price': 3987.20,'confidence': 78,'reason': 'Golden ratio resistance + overbought RSI'}
                ]
